$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("com/mpqa/test/workflows/BunningsWishList.feature");
formatter.feature({
  "line": 2,
